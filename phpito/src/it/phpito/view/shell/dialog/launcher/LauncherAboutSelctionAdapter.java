...
public class LauncherAboutSelctionAdapter extends ShellDialogPHPito implements SelectionListener {
...
//		ShellDialogPHPito shellDialog = new ShellDialogPHPito(getShellPHPito());
		launchSettingPHPito();
	}
